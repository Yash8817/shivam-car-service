  ...
  <div class="container grid px-6 mx-auto">
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
      <div class="w-full overflow-x-auto">
        ...
        $sql = "SELECT user.user_name ,user.user_email, user.user_phone,staff.is_attendee,staff.staff_id,
                          staff.hire_date , staff.salary FROM user JOIN staff ON user.user_id = staff.Useruser_id  LIMIT {$offset},{$limit}";
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                  ...
                  <td class="px-4 py-3" >
                    <div class="flex items-center space-x-4 text-sm" >
                      ...
                      <a href="add-staff.php?id=<?php echo $row['staff_id']; ?>">
                    ...
                    onclick="return confirm('Are you sure you want to delete staff ?');">
                        <a href="delete-staff.php?id=<?php echo $row['staff_id']; ?>">
                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div class="grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
        ...
        <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
          ...
          if (mysqli_num_rows($result1) > 0) {
            ...
            if ($page > 1) {
              echo '<li><a href="staff.php?page=' . ($page - 1) . '">Prev&nbsp;</a></li>' . "  ";
            }
            ...
            if ($total_page > $page) {
              echo '<li><a href="staff.php?page=' . ($page + 1) . '">&nbsp;Next</a></li>';
            }
