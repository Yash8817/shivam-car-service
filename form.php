...
<script>function validateForm() {
  let x = document.forms["register"]["first_name"].value;
  if (x == "") {
...
<meta charset="utf-8">
	...
	<!-- Font-->
	<link rel="stylesheet" type="text/css" href="assert/css/opensans-font.css">
	<link rel="stylesheet" type="text/css" href="assert/fonts/material-design-iconic-font/css/material-design-iconic-font.min.css">
	<!-- datepicker -->
	<link rel="stylesheet" type="text/css" href="assert/css/jquery-ui.min.css">
	<!-- Main Style Css -->
...
<?php require "top.php" ?>
	<div class="page-content">
		...
		<div class="wizard-v6-content">
			<div class="wizard-form">
		        <form class="form-register" id="form-register" name="register" action="#" method="post">
		        	<div id="form-total">
		        		<!-- SECTION 1 -->
			            <h2>
			            	<p class="step-icon"><span>1</span></p>
			            	<span class="step-text" id="sectionVI1">Personal Info</span>
			            </h2>
			            <section >
			                <div class="inner">
								...
								<a href="#sectionVI2">
								<button type="submit" val="submit" class="" >submit</button>
								</a>
							</div>
			            </section>
			            ...
			            <h2>
			            	...
			            	<span class="step-text" id="sectionVI2">Vehicle Info</span>
			            </h2>
			            <section>
			                <div class="inner">
			                	<div class="form-heading">
	...
	<script src="assert/js/jquery.steps.js"></script>
