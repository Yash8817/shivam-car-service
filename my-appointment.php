        ...
        <div class="col-md-3 col-sm-3">
            ...
            <div class="col-md-6 col-sm-8">
                <div class="profile_wrap">
                    ...
                    <a href="../shivam/bookapp.php">
                        <button type="submit" name="updateprofile" class="mybtn" id="btn">New appointment <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                    </a>
                    ...
                    <div class="my_vehicles_list">
                        ...
                        <table class="table table-hover table-fixed">
                            <?php
                            $sql = "SELECT appointment.* ,vehicle.rto_number , model.model_name ,appointment.statusstatus_id  FROM appointment  JOIN vehicle ON appointment.Vehicle_rto_number = vehicle.rto_number JOIN model ON model.car_model_id = vehicle.modelcar_model_id  WHERE appointment.customercustomer_id = $customer_id ORDER BY appointment.app_date DESC";
                            // echo $sql;
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                    <a href="view-appoiment.php?a_id=<?php echo $row['appointment_id'];   ?>">
                                                        <?php
                                                        echo "Confirmed";
                                                        ?>
                                                    </a>
